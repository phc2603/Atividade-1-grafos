...
- Deve-se executar os arquivos da mesma forma que no TP1, contudo, devem ser executados os arquivos:
- directedGraphMatrix.py
- nonDirectedGraphMatrix.py
- directGraphList.py
- nonDirectedGraphList.py
